...
class gurdyJointMover(object):
    ...
    def gurdy_movement_look(self, upperlegM1_angle, upperlegM2_angle, upperlegM3_angle, upperlegM4_angle, lowerlegM1_value, lowerlegM2_value ,lowerlegM3_value, lowerlegM4_value):
        """
        Move:
        ...
        while not (similar_upperlegM1 and similar_upperlegM2 and similar_upperlegM3 and similar_lowerlegM1 and similar_lowerlegM2 and similar_lowerlegM3):
            ...
            similar_upperlegM4 = self.gurdy_check_continuous_joint_value(joint_name="head_upperlegM4_joint",
            ...
            similar_lowerlegM4 = self.gurdy_check_continuous_joint_value(joint_name="upperlegM4_lowerlegM4_joint",
                                                                         value=position_lowerlegM3)
